...
public class BattleshipModel {
    ...
    public void shootAtComputer(int row, int col) {
       ...
       /*
        Coordinate clipper_1 = new Coordinate(7,3);
        Coordinate clipper_2 = new Coordinate(7,4);
        Coordinate clipper_3 = new Coordinate(7,5);
        if(computerHits.contains(clipper_1) || computerHits.contains(clipper_2) || computerHits.contains(clipper_3)){
            computerHits.add(clipper_3);
            computerHits.add(clipper_2);
            computerHits.add(clipper_1);
        }      */
    }
